...
- [TheAltStack](https://thealtstack.com) - Directory of 450+ open-source alternatives to proprietary SaaS with Docker deployment configs. ([Source Code](https://github.com/altstackHQ/altstack-data)) `Apache-2.0` `Nodejs`
